...
namespace Intern4job.Web.Utility
{
    public class HttpClientHelper
    {
        ...
        public HttpClientHelper(string url, HttpClientContext context)
        ...
        public HttpClientHelper(string url, HttpClientContext context, bool keepContext)
        {
            this.url = url;
